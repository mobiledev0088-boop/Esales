...
const FilterButton: React.FC<FilterButtonProps> = ({
  ...
  containerStyle,
    ...
    const classStyle = twMerge(clsx('p-4 rounded-md bg-lightBg-surface dark:bg-darkBg-surface',needBorder ? 'border border-gray-200 dark:border-gray-700' : '',containerClassName)); 
