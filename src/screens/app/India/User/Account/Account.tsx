...
import { AccountSettings, PersonalDetails, ProfileCard, SpecialAccessUI, SyncedDate } from './component';
  ...
  return ( 
    <AppLayout title="Account" needScroll>
      <View className="flex-1 px-4 pt-4">
        ...
        {/* Synced Data Info */}
       {userInfo?.EMP_Btype !== 4 && <SyncedDate userInfo={userInfo} empInfo={empInfo} />}

        {/* Personal Details */}
        <PersonalDetails userInfo={userInfo} empInfo={empInfo} />

        {/* Special Access Functions */}
        <SpecialAccessUI specialFunctionsAccess={specialFunctionsAccess} userInfo={userInfo} />
